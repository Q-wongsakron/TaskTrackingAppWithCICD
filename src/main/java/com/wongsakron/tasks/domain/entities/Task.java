...
public class Task {
    ...
    @ManyToOne(fetch = FetchType.LAZY) // Lazy loading to avoid fetching the entire TaskList when only Task is needed
    @JoinColumn(name = "task_list_id") // foreign key column
    private TaskList taskList; // Assuming TaskList is another entity that this Task belongs to
